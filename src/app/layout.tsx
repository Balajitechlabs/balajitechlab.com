...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Official engineering portfolio of Balaji S. (balajitechlabs) — Principal Android Architect, Full-Stack Developer & CS Engineer from India 🇮🇳.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Balaji S. (balajitechlabs) — Principal Android Architect & Developer",
    description:
      "Android Architect, Full-Stack Developer & CS Engineer from India 🇮🇳. Creator of QuickDash and Luxora OS.",
  ...
  "@graph": [
    {
      ...
      name: "Balaji S.",
      alternateName: ["balajitechlabs", "balaji_developer", "||BTL||™"],
      ...
      sameAs: [
        ...
        "https://reddit.com/r/balajitechlabs",
      ],
      nationality: {
        "@type": "Country",
        name: "India",
    ...
    },
    {
      ...
      description: "Official engineering portfolio and open-source project showcase of Balaji S.",
      publisher: {
        "@id": "https://balajitechlab.com/#person",
      },
    },
